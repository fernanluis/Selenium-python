...
driver.execute_script("window.open('');") # una forma de abrir una pestaña en un navegador
# métodos que ermiten navegar entre las pestañas. son 3

# movilizar hacia otra pestaña
driver.switch_to.window(driver.linux_handles[1])
driver.get('https://sites.google.com/a/chromium.org/chromedriver/')

driver.switch_to.window(driver.linux_handles[0])
